...
class Reticle(AbstractWidget):
    def __init__(self, name, container, cursorcolor, target_proportion=0.1, m_draw=None):
        ...
        v1 = [cx, cy, x2, cy, x2, y2, x2 - self.corner_width, y2, x2, y2, x2, y2 + self.corner_width]
    ...
    def get_cursor_vertice(self):
        v = self.vertice_strip(self.vertice_circle(self.cursor_absolute, self.cursor_radius, 20))
        v.extend(
            [
